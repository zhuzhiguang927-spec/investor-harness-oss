...
- Agent builders designing domain-specific workflows
- Researchers who want more auditable AI outputs
- Maintainers experimenting with Markdown-first skill routing
- Developers building Codex / Claude Code / OpenCode / generic agent skill packs

## Notes

This project is a workflow harness, not a financial adviser. Outputs should not be treated as personalized investment advice.
